      ...
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-center py-32 px-16 bg-white dark:bg-black">
        <div className="w-full max-w-md bg-white dark:bg-black rounded-lg shadow-md p-8 justify-center">
          ...
          <div className="flex flex-row gap-2">
            <input type="radio" id="remember" name="remember" checked={termsAccepted} onChange={(e) => setTermsAccepted(!termsAccepted)} className="mb-4" />
            <p className="ml-2 text-sm text-gray-600 dark:text-gray-400">I agree to the Terms and Conditions & Privacy Policy</p>
          </div>
