...
export default function VerifyEmailPrompt({profileId}: { profileId: string }) {
    ...
    if (isSelf && isUnverified && visible) {
        return (
            <div className="flex flex-col items-center justify-center gap-4 w-full bg-blue-50 dark:bg-blue-900 rounded-lg p-6 border border-blue-200 dark:border-blue-700 mb-8">
                ...
                <div className="flex gap-4 items-center w-full">
                    ...
                    <button className="w-full bg-zinc-200 dark:bg-zinc-700 rounded-md px-4 py-2 hover:bg-zinc-300 dark:hover:bg-zinc-600 text-center">
                        Maybe later
                    </button>
                </div>
            </div>
